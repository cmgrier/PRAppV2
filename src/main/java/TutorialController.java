...
public class TutorialController implements Initializable {
    ...
    public void Tutorial(){
        if(PageSelect.getCurrentPageIndex() == 0){
        ...
        } else if(PageSelect.getCurrentPageIndex() == 1){
        ...
        } else if(PageSelect.getCurrentPageIndex() == 2){
        ...
        } else if(PageSelect.getCurrentPageIndex() == 3){
